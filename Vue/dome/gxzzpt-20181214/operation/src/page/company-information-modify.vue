<template>
  ...
  <div class="information-tabs-content information-first">
      <div class="information-tabs-left pull-left">
                ...
                <div class="modifyData pull-left">
                  <p class="c-introduction-name1 c-introduction-name">
                      ...
                      <span class="pull-block">
                          <el-form-item >
                              <el-input v-model="dynamicValidateForm.shortName" :disabled="false"></el-input>
                          </el-form-item>
                      </span>
                  </p>
                  <p class="c-introduction-name2 c-introduction-name">
                      ...
                      <span class=" pull-block">
                          <el-form-item >
                              <el-input v-model="dynamicValidateForm.companyName" :disabled="false"></el-input>
          ...
          <div  class="tabs-content pull-top" v-if="this.dynamicValidateForm.isManufacturer==true">
          ...
          <div class="tabs-content pull-top" v-if="this.dynamicValidateForm.isManufacturer==true">
            ...
            <div class="tabs-text tableData">
              ...
              <el-table-column   label="操作" align="center" width="50">
                  <template slot-scope="scope">
                      <i class="el-icon-delete pull-cursor" @click="removeTableData(scope.row,scope.$index)"></i>
                  </template>
              </el-table-column>
              </el-table>
              <div class="projectAdd">
          ...
          <div class="tabs-content pull-top modifyText" v-if="this.dynamicValidateForm.isManufacturer==true">
            <span class="tabs-title">行业与客户</span>
            <div class="tabs-text Fixed-info">
              <el-row>
              <el-col :span="24">
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24">倾向订单类型：</el-col>
                  <el-col :span="24">
              ...
              <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">主要出口市场：</el-col>
                  <el-col :span="24">
                  <el-form-item >
              ...
              <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">第一优势行业：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">第一主要客户：</el-col>
                  <el-col :span="24">
                      <el-form-item >
              ...
              <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">第二主要客户：</el-col>
                  <el-col :span="24">
                      <el-form-item >
              ...
              <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">第三主要客户：</el-col>
                  <el-col :span="24">
                      <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">代表性产品：</el-col>
                  <el-col :span="24">
                      <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">合作过的企业：</el-col>
                  <el-col :span="24">
                      <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">行业类型：</el-col>
                  <el-col :span="24">
                      <el-form-item >
      ...
      <div class="information-tabs-right pull-left">
          <div class="tabs-content" v-if="this.dynamicValidateForm.isManufacturer==true">
          ...
          <div class="tabs-content modifyText" :class="this.dynamicValidateForm.isManufacturer==true?'pull-top':''">
            ...
            <div class="tabs-text Fixed-info">
              <el-row>
                <el-col :span="24" class="Fixed-info-top">
                  ...
                  <el-col :span="19">
                        <div style="line-height: 17px;">{{dynamicValidateForm.companyName}}</div>
                  </el-col>
                </el-col>
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">住所：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <!-- <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">帐号：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">联系电话：</el-col>
                  <el-col :span="24">
                ...
                <!-- <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">法定代表人：</el-col>
                  <el-col :span="24">
                  <el-form-item >
          ...
          <div class="tabs-content pull-top modifyText" v-if="this.dynamicValidateForm.isManufacturer==true">
            ...
            <div class="tabs-text Fixed-info">
              <el-row>
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">银行：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">姓名：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">账号：</el-col>
                  <el-col :span="24">
                  <el-form-item >
          ...
          <div class="tabs-content pull-top modifyText" v-if="this.dynamicValidateForm.isManufacturer==true">
            ...
            <div class="tabs-text Fixed-info">
              <el-row>
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">国家：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">省市：<span v-if="selectStats==true" style="font-size: 12px;color: #6f6f6f">( 国外省市区域暂不支持选择 )</span></el-col>
                  <el-col :span="24">
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">地址：</el-col>
                  <el-col :span="24">
                      <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">企业类型：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">成立年份：</el-col>
                  <el-col :span="24">
                      <el-form-item >
                          <el-date-picker
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">雇员数量：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">科研人员数量：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">设计人员数量：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">质检人员数量：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">工厂面积：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">年产值：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">最大年产能：</el-col>
                  <el-col :span="24">
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">总资产：</el-col>
                  <el-col :span="24">
                      <el-form-item class="border-R-No">
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">进出口权：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">出口比例：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">ODM能力：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">公司性质：</el-col>
                  <el-col :span="24">
                  <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">信息化系统：</el-col>
                  <el-col :span="24">
                      <el-form-item >
                ...
                <el-col :span="24" class="Fixed-info-top">
                  <el-col :span="24" class="modify-title">网站：</el-col>
                  <el-col :span="24">
                      <el-form-item >
      ...
      selectList:[],
       //企业资料--修改
        ...
        dynamicRules:{
          ...
          fax:[{required: true, validator: validateFax}],
        },
        TradeList:[],//行业类型
        invoiceData:[],
        invoiceInfoData:[],
  ...
  methods: {
     ...
     AddTableData(){
      ...
      removeAuthenticationData(row,index){
        this.dynamicValidateForm.qualificationInfo.splice(index, 1);
      },
    ...
    UploadSaves(formSate,formName){
      if(formSate==true){
        ...
        this.$refs[formName].validate(valid => {
            if (valid) {
                this.dynamicValidateForm.province=this.selectStats==false?this.dynamicValidateForm.selectList[0]:'';
                this.dynamicValidateForm.city=this.selectStats==false?this.dynamicValidateForm.selectList[1]:'';
                this.dynamicValidateForm.region=this.selectStats==false?this.dynamicValidateForm.selectList[2]:'';
                this.dynamicValidateForm.extendInfo.ioRight=this.dynamicValidateForm.extendInfo.ioRights=='true'?true:false;
                this.dynamicValidateForm.extendInfo.odmAbility=this.dynamicValidateForm.extendInfo.odmAbilitys=='true'?true:false;
                this.dynamicValidateForm.coopInfo.orderType=parseInt(this.dynamicValidateForm.coopInfo.orderType)
                this.dynamicValidateForm.coopInfo.coopCompanys=this.dynamicValidateForm.coopCompanysCopy===''?[]:this.dynamicValidateForm.coopCompanysCopy.split(",");
                this.dynamicValidateForm.coopInfo.mainWorks=this.dynamicValidateForm.mainWorksCopy===''?[]:this.dynamicValidateForm.mainWorksCopy.split(",");
                this.dynamicValidateForm.coopInfo.industryIds=this.dynamicValidateForm.industryInfo;
                this.dynamicValidateForm.companyId=parseInt(this.$route.query.companyId);
                this.dynamicValidateForm.contract.tel= this.dynamicValidateForm.tel;
                this.dynamicValidateForm.contract.fax= this.dynamicValidateForm.fax;
                this.dynamicValidateForm.invoiceInfo=this.invoiceInfoData;
                let url="/operation/company/updateInfo";
                this.$emit('Save-list',true,false);
                this.$http.post(url,this.dynamicValidateForm).then(res=>{
    ...
    this.$http.post('/getWords').then(res=>{
        if(res.data.code==200){
          ...
          for(let i in jsonObj){
            ...
            if(i==124){this.companyPropertyStr=jsonObj[i].item}
            if(i==125){this.Employee=jsonObj[i].item}
            if(i==133){this.enterpriseType=jsonObj[i].item}
            if(i==134){this.CoverArea=jsonObj[i].item}
            if(i==135){this.yearlyOutput=jsonObj[i].item}
            if(i==136){this.ExportArea=jsonObj[i].item}
            if(i==137){this.EquipmentTypeData=jsonObj[i].item}
            if(i==140){this.SmallScale=jsonObj[i].item}
            if(i==141){this.exportRateStr=jsonObj[i].item}
            if(i==142){this.countryInfoList=jsonObj[i].item}
            // if(i==149){this.BankList=jsonObj[i].item}
            if(i==139){this.certTypeList=jsonObj[i].item}
          }
        }
     })
  this.industryCheck();
