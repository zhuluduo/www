...
<template>
    <div class="add-subaccount">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>添加子账户</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="content">
            <div class="base-form form clearfix">
                <div class="title ">基本信息</div>
                    <el-form :model="baseForm" :rules="rules" ref="baseForm" label-position="left" label-width="67px" >
                        <el-col :span="8">
...
<script>
import {validatePhone,validatPassword, validateEmail,EmailAuto} from '../lib/validate.js'
export default {
    data() {
        return {
            checkedPermissions:[],
    ...
    methods:{
        ...
        addAccount() {
            this.$refs.baseForm.validate(( valid ) => {
                ...
                this.$http.post('/operation/user/insertSubAccount', params).then(( res ) => {
                    if ( res.data.code == 200 ) {
