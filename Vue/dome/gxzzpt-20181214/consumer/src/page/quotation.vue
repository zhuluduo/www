        ...
        <div class="content">
            ...
            <div class="content-item">
                ...
                <div class="content-item-box part-info-box">
                    <table v-if="data.requirement&&data.requirement.priceTemplate==490010">
                        <thead>
                            <tr>
                                ...
                                <td width="150px">报价阶梯</td>
                                <td width="180px">报价</td>
                                <td width="162px">交付日</td>
                         ...
                         <tbody v-for="(item,index) in data.requirementPriceItems" :key="'tbody' + index" :ref="'requirementItem'+index" v-if="item.isLadderPrice">
                             <tr>
                                ...
                                <td>
                                    <input :class="{'red-border': item.defDeliveryTime.showErrorMsg}" v-model="item.defDeliveryTime.value" @blur="validate($event, /^[0-9]+$/, item.defDeliveryTime)"
                                        :disabled="item.isAbandon||data.acceptStatus!=450010||data.requirement.requirementStatus!=107020"
                         ...
                         <tbody v-else :key="'tbody' + index" :ref="'requirementItem'+index">
                             <tr>
                                 ...
                                 <td>{{item.itemName}}</td>
                                 <td>{{item.estimateCount}}</td>
                                 <td><input :class="{'red-border': item.defMinCount.showErrorMsg}" v-model="item.defMinCount.value" @blur="validate($event, /^[0-9]+$/, item.defMinCount)" :disabled="item.isAbandon||(data.acceptStatus!=450010||data.requirement.requirementStatus!=107020)"
                                        @input="validate($event, /^[0-9]+$/, item.defMinCount)" maxlength="9" type="text" class="input-item" placeholder=""></td>
                                 ...
                                 <td class="td-with-bt-border">
                                    <input :class="{'red-border': item.defSinglePrice.showErrorMsg}" v-model="item.defSinglePrice.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.defSinglePrice)" :disabled="item.isAbandon||(data.acceptStatus!=450010||data.requirement.requirementStatus!=107020)"
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.defSinglePrice)" maxlength="9" type="text" class="input-item" placeholder="">
                                    <span>￥件</span>
                                </td>
                                <td>
                                    <input :class="{'red-border': item.defDeliveryTime.showErrorMsg}" v-model="item.defDeliveryTime.value" @blur="validate($event, /^[0-9]+$/, item.defDeliveryTime)"
                        ...
                        <thead>
                         ...
                         <tbody v-for="(item,index) in data.requirementPriceItems" :key="'tbody' + index" :ref="'requirementItem'+index" v-if="item.isLadderPrice">
                             <tr>
                                 ...
                                 <td class="td-with-rg-border">{{item.priceInfo[0].from}}-{{item.priceInfo[0].to}}</td>
                                 ...
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.materialPrice1.weight.showErrorMsg}" v-model="item.materialPrice1.weight.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.materialPrice1.weight)" maxlength="9" class="input-item wd-32" type="text"></td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.materialPrice1.singlePrice.showErrorMsg}" v-model="item.materialPrice1.singlePrice.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.materialPrice1.singlePrice)" maxlength="9" class="input-item wd-32" type="text">
                                 </td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.materialPrice1.processingTime.showErrorMsg}" v-model="item.materialPrice1.processingTime.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.materialPrice1.processingTime)" maxlength="9" class="input-item wd-32" type="text">
                                 </td>
                                 <td class="td-with-bt-border td-with-lf-border">
                                     <input :class="{'red-border': item.processPrice1.singlePrice.showErrorMsg}" v-model="item.processPrice1.singlePrice.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.processPrice1.singlePrice)" maxlength="9" class="input-item wd-32" type="text">
                                 </td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.processPrice1.price.showErrorMsg}" v-model="item.processPrice1.price.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.processPrice1.price)" maxlength="9" class="input-item wd-32" type="text">
                                 </td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.processPrice1.rate.showErrorMsg}" v-model="item.processPrice1.rate.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.processPrice1.rate)" maxlength="9" class="input-item wd-32" type="text">
                                 </td>
                                 ...
                                 <td class="td-with-bt-border td-with-lf-border">
                                     <input :class="{'red-border': item.defManagementPrice1.showErrorMsg}" v-model="item.defManagementPrice1.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.defManagementPrice1)" maxlength="9" class="input-item wd-68" type="text">
                                 </td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.defPrice1.showErrorMsg}" v-model="item.defPrice1.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.defPrice1)" maxlength="9" class="input-item wd-68" type="text">
                                 </td>
                             ...
                             <tr>
                                 ...
                                 <td></td>
                                 <td></td>
                                 <td class="td-with-rg-border">{{item.priceInfo[1].from}}-{{item.priceInfo[1].to}}</td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.materialPrice2.weight.showErrorMsg}" v-model="item.materialPrice2.weight.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.materialPrice2.weight)" maxlength="9" class="input-item wd-32" type="text"></td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.materialPrice2.singlePrice.showErrorMsg}" v-model="item.materialPrice2.singlePrice.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.materialPrice2.singlePrice)" maxlength="9" class="input-item wd-32" type="text">
                                 </td>
                                 <td class="td-with-bt-border">
                                 ...
                                 <td class="td-with-bt-border td-with-lf-border">
                                     <input :class="{'red-border': item.processPrice2.singlePrice.showErrorMsg}" v-model="item.processPrice2.singlePrice.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.processPrice2.singlePrice)" maxlength="9" class="input-item wd-32" type="text">
                                 </td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.processPrice2.price.showErrorMsg}" v-model="item.processPrice2.price.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.processPrice2.price)" maxlength="9" class="input-item wd-32" type="text">
                                 </td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.processPrice2.rate.showErrorMsg}" v-model="item.processPrice2.rate.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.processPrice2.rate)" maxlength="9" class="input-item wd-32" type="text">
                                 </td>
                                 <td class="td-with-bt-border td-with-lf-border">
                                     <input :class="{'red-border': item.defManagementPrice2.showErrorMsg}" v-model="item.defManagementPrice2.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.defManagementPrice2)" maxlength="9" class="input-item wd-68" type="text">
                                 </td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.defPrice2.showErrorMsg}" v-model="item.defPrice2.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.defPrice2)" maxlength="9" class="input-item wd-68" type="text">
                                 </td>
                                 <td class="td-with-bt-border"></td>
                             </tr>
                             <tr>
                                 ...
                                 <td></td>
                                 <td></td>
                                 <td class="td-with-rg-border">>={{item.priceInfo[2].from}}</td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.materialPrice3.weight.showErrorMsg}" v-model="item.materialPrice3.weight.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.materialPrice3.weight)" maxlength="9" class="input-item wd-32" type="text"></td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.materialPrice3.singlePrice.showErrorMsg}" v-model="item.materialPrice3.singlePrice.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.materialPrice3.singlePrice)" maxlength="9" class="input-item wd-32" type="text">
                                 </td>
                                 <td class="td-with-bt-border">
                                 ...
                                 <td class="td-with-bt-border td-with-lf-border">
                                     <input :class="{'red-border': item.processPrice3.singlePrice.showErrorMsg}" v-model="item.processPrice3.singlePrice.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.processPrice3.singlePrice)" maxlength="9" class="input-item wd-32" type="text">
                                 </td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.processPrice3.price.showErrorMsg}" v-model="item.processPrice3.price.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.processPrice3.price)" maxlength="9" class="input-item wd-32" type="text">
                                 </td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.processPrice3.rate.showErrorMsg}" v-model="item.processPrice3.rate.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.processPrice3.rate)" maxlength="9" class="input-item wd-32" type="text">
                                 </td>
                                 <td class="td-with-bt-border td-with-lf-border">
                                     <input :class="{'red-border': item.defManagementPrice3.showErrorMsg}" v-model="item.defManagementPrice3.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.defManagementPrice3)" maxlength="9" class="input-item wd-68" type="text">
                                 </td>
                                 <td class="td-with-bt-border">
                                     <input :class="{'red-border': item.defPrice3.showErrorMsg}" v-model="item.defPrice3.value" @blur="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/,
                                        ...
                                        @input="validate($event, /^[0-9]+([.]{1}[0-9]{1,2})?$/, item.defPrice3)" maxlength="9" class="input-item wd-68" type="text">
                                 </td>
                                 <td class="td-with-bt-border"></td>
                             </tr>
                         </tbody>
...
import {EmailAuto} from '../lib/validate.js';
export default {
    components:{
        'v-checkBtn': CheckBtn
    },
                    ...
                    if ( this.data.requirement.priceTemplate ==490010 ) {
                        this.data.requirementPriceItems.map(( item ) => {
                            if ( item.isLadderPrice ) {
                                this.$set( item, 'price1', {value:(item.priceInfo&&item.priceInfo[0].price)||'',isCheck: (item.priceInfo&&item.priceInfo[0].price)?true:false, showErrorMsg: false,} );
                                this.$set( item, 'price2', {value:(item.priceInfo&&item.priceInfo[1].price)||'',isCheck: (item.priceInfo&&item.priceInfo[1].price)?true:false, showErrorMsg: false,} );
                                this.$set( item, 'price3', {value:(item.priceInfo&&item.priceInfo[2].price)||'',isCheck: (item.priceInfo&&item.priceInfo[2].price)?true:false, showErrorMsg: false,} );
                            } else {
                                this.$set( item, 'defSinglePrice', {value:(item.priceInfo&&item.priceInfo.price)||'',isCheck: (item.priceInfo&&item.priceInfo.price)?true:false, showErrorMsg: false,} );
                            }
                        ...
                        this.data.requirementPriceItems.map(( item ) => {
                            if ( item.isLadderPrice ) {
                                this.$set( item, 'defMaterial', {value: item.material||'', isCheck: item.material?true:false, showErrorMsg: false});
                                this.$set( item, 'defManagementPrice1', {value: item.priceInfo?item.priceInfo[0].managementPrice:'', isCheck: item.priceInfo?true:false, showErrorMsg: false});
                                this.$set( item, 'defManagementPrice2', {value: item.priceInfo?item.priceInfo[1].managementPrice:'', isCheck: item.priceInfo?true:false, showErrorMsg: false});
                                this.$set( item, 'defManagementPrice3', {value: item.priceInfo?item.priceInfo[2].managementPrice:'', isCheck: item.priceInfo?true:false, showErrorMsg: false});
                                this.$set( item, 'defPrice1', {value: item.priceInfo?item.priceInfo[0].price:'', isCheck: item.priceInfo?true:false, showErrorMsg: false});
                                this.$set( item, 'defPrice2', {value: item.priceInfo?item.priceInfo[1].price:'', isCheck: item.priceInfo?true:false, showErrorMsg: false});
                                this.$set( item, 'defPrice3', {value: item.priceInfo?item.priceInfo[2].price:'', isCheck: item.priceInfo?true:false, showErrorMsg: false});
                                this.$set( item, 'materialPrice1', {
                                    weight:{value: (item.priceInfo&&item.priceInfo[0].materialPrice)?item.priceInfo[0].materialPrice.weight:'', isCheck: (item.priceInfo&&item.priceInfo[0].materialPrice)?true:false, showErrorMsg: false},
                                    singlePrice:{value: (item.priceInfo&&item.priceInfo[0].materialPrice)?item.priceInfo[0].materialPrice.singlePrice:'', isCheck: (item.priceInfo&&item.priceInfo[0].materialPrice)?true:false, showErrorMsg: false},
                                    processingTime:{value: (item.priceInfo&&item.priceInfo[0].materialPrice)?item.priceInfo[0].materialPrice.processingTime:'', isCheck: (item.priceInfo&&item.priceInfo[0].materialPrice)?true:false, showErrorMsg: false}
                                });
                                this.$set( item, 'materialPrice2', {
                                    weight:{value: (item.priceInfo&&item.priceInfo[1].materialPrice)?item.priceInfo[1].materialPrice.weight:'', isCheck: (item.priceInfo&&item.priceInfo[1].materialPrice)?true:false, showErrorMsg: false},
                                    singlePrice:{value: (item.priceInfo&&item.priceInfo[1].materialPrice)?item.priceInfo[1].materialPrice.singlePrice:'', isCheck: (item.priceInfo&&item.priceInfo[1].materialPrice)?true:false, showErrorMsg: false},
                                    processingTime:{value: (item.priceInfo&&item.priceInfo[1].materialPrice)?item.priceInfo[1].materialPrice.processingTime:'', isCheck: (item.priceInfo&&item.priceInfo[1].materialPrice)?true:false, showErrorMsg: false}
                                });
                                this.$set( item, 'materialPrice3', {
                                    weight:{value: (item.priceInfo&&item.priceInfo[2].materialPrice)?item.priceInfo[2].materialPrice.weight:'', isCheck: (item.priceInfo&&item.priceInfo[2].materialPrice)?true:false, showErrorMsg: false},
                                    singlePrice:{value: (item.priceInfo&&item.priceInfo[2].materialPrice)?item.priceInfo[2].materialPrice.singlePrice:'', isCheck: (item.priceInfo&&item.priceInfo[2].materialPrice)?true:false, showErrorMsg: false},
                                    processingTime:{value: (item.priceInfo&&item.priceInfo[2].materialPrice)?item.priceInfo[2].materialPrice.processingTime:'', isCheck: (item.priceInfo&&item.priceInfo[2].materialPrice)?true:false, showErrorMsg: false}
                                });
                                this.$set( item, 'processPrice1', {
                                    price:{value: (item.priceInfo&&item.priceInfo[0].processPrice)?item.priceInfo[0].processPrice.price:'', isCheck: (item.priceInfo&&item.priceInfo[0].processPrice)?true:false, showErrorMsg: false},
                                    singlePrice:{value: (item.priceInfo&&item.priceInfo[0].processPrice)?item.priceInfo[0].processPrice.singlePrice:'', isCheck: (item.priceInfo&&item.priceInfo[0].processPrice)?true:false, showErrorMsg: false},
                                    rate:{value: (item.priceInfo&&item.priceInfo[0].processPrice)?item.priceInfo[0].processPrice.rate:'', isCheck: (item.priceInfo&&item.priceInfo[0].processPrice)?true:false, showErrorMsg: false}
                                });
                                this.$set( item, 'processPrice2', {
                                    price:{value: (item.priceInfo&&item.priceInfo[1].processPrice)?item.priceInfo[1].processPrice.price:'', isCheck: (item.priceInfo&&item.priceInfo[1].processPrice)?true:false, showErrorMsg: false},
                                    singlePrice:{value: (item.priceInfo&&item.priceInfo[1].processPrice)?item.priceInfo[1].processPrice.singlePrice:'', isCheck: (item.priceInfo&&item.priceInfo[1].processPrice)?true:false, showErrorMsg: false},
                                    rate:{value: (item.priceInfo&&item.priceInfo[1].processPrice)?item.priceInfo[1].processPrice.rate:'', isCheck: (item.priceInfo&&item.priceInfo[1].processPrice)?true:false, showErrorMsg: false}
                                });
                                this.$set( item, 'processPrice3', {
                                    price:{value: (item.priceInfo&&item.priceInfo[2].processPrice)?item.priceInfo[2].processPrice.price:'', isCheck: (item.priceInfo&&item.priceInfo[2].processPrice)?true:false, showErrorMsg: false},
                                    singlePrice:{value: (item.priceInfo&&item.priceInfo[2].processPrice)?item.priceInfo[2].processPrice.singlePrice:'', isCheck: (item.priceInfo&&item.priceInfo[2].processPrice)?true:false, showErrorMsg: false},
                                    rate:{value: (item.priceInfo&&item.priceInfo[2].processPrice)?item.priceInfo[2].processPrice.rate:'', isCheck: (item.priceInfo&&item.priceInfo[2].processPrice)?true:false, showErrorMsg: false}
                                });
                            } else {
                                this.$set( item, 'defMaterial', {value: item.material||'', isCheck: item.material?true:false, showErrorMsg: false});
                                this.$set( item, 'defManagementPrice1', {value: item.priceInfo?item.priceInfo.managementPrice:'', isCheck: item.priceInfo?true:false, showErrorMsg: false});
                                this.$set( item, 'defPrice1', {value: item.priceInfo?item.priceInfo.price:'', isCheck: item.priceInfo?true:false, showErrorMsg: false});
                                this.$set( item, 'materialPrice1', {
                                    weight:{value: (item.priceInfo&&item.priceInfo.materialPrice)?item.priceInfo.materialPrice.weight:'', isCheck: (item.priceInfo&&item.priceInfo.materialPrice)?true:false, showErrorMsg: false},
                                    singlePrice:{value: (item.priceInfo&&item.priceInfo.materialPrice)?item.priceInfo.materialPrice.singlePrice:'', isCheck: (item.priceInfo&&item.priceInfo.materialPrice)?true:false, showErrorMsg: false},
                                    processingTime:{value: (item.priceInfo&&item.priceInfo.materialPrice)?item.priceInfo.materialPrice.processingTime:'', isCheck: (item.priceInfo&&item.priceInfo.materialPrice)?true:false, showErrorMsg: false}
                                });
                                this.$set( item, 'processPrice1', {
                                    price:{value: (item.priceInfo&&item.priceInfo.processPrice)?item.priceInfo.processPrice.price:'', isCheck: (item.priceInfo&&item.priceInfo.processPrice)?true:false, showErrorMsg: false},
                                    singlePrice:{value: (item.priceInfo&&item.priceInfo.processPrice)?item.priceInfo.processPrice.singlePrice:'', isCheck: (item.priceInfo&&item.priceInfo.processPrice)?true:false, showErrorMsg: false},
                                    rate:{value: (item.priceInfo&&item.priceInfo.processPrice)?item.priceInfo.processPrice.rate:'', isCheck: (item.priceInfo&&item.priceInfo.processPrice)?true:false, showErrorMsg: false}
                                });
                            }
                        })
                    }
