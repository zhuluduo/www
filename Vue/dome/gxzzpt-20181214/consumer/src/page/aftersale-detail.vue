    ...
    <div id="aftersale-detail">
        <div class="content">
            <div class="top">
                ...
                <div class="state text-item" v-if="data.dealResult!=400020">{{data.dealResultStr}}</div>
                <div class="state text-item" style="color: rgb(245, 108, 108);" v-if="data.dealResult==400020">{{data.dealResultStr}}</div>
            </div>
            ...
            <div class="content-item">
                ...
                <div class="content-box">
                    ...
                    <div class="row-info" v-if="data.operationRemark">说明：{{data.operationRemark}}</div>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        getData() {
            this.$http.post('/custom/afterServiceRecord/get',{id: this.id}).then(( res ) => {
