  ...
  <div>
    ...
    <el-row :gutter="2">
      ...
      <el-col :span="4" class="tool-bar">
        ...
        <el-button type="primary" @click="save(list)" size="small">创建入库单</el-button>
      </el-col>
    </el-row>
    <el-row>
      <el-col>
    ...
    <el-dialog title="选择商品" :visible.sync="productDialogVisible">
      <el-row :gutter="10">
        ...
        <el-col :span="19">
          ...
          <el-row>
            <el-table v-loading="loading" element-loading-text="加载中..." :data="products" ref="multipleTable" row-key="id"
      ...
      <el-row>
        <el-col align="right">
          <el-button @click="productDialogVisible= false" size="small">取 消</el-button>
