<template>
  <div>
    <el-row class="breadcrumb-border">
      <el-col>
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: '/scrap/list' }">出库单</el-breadcrumb-item>
    ...
    <el-dialog  title="出库添加成功"  :visible.sync="showDialog" :close-on-click-modal="false" :close-on-press-escape="false"  :show-close="false" size="tiny" class="dialog_box">
      <el-row :gutter="20">
        <div >
