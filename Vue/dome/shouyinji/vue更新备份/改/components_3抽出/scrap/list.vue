<template>
  <div>
    ...
    <el-row class="data-table" :gutter="2">
      ...
      <el-col :span="4">
        <el-input @keyup.enter.native="search" placeholder="出库单号" v-model="params.searchWord" size="small"/>
      </el-col>
    ...
    <el-row>
      <el-col>
        <el-table stripe border :data="list" v-loading="loading" element-loading-text="数据加载中" @sort-change="sortList"
          ...
          <el-table-column sortable="custom" prop="user.telephone" label="出库人" align="center"/>
