<template>
  <el-row class="warp">
    ...
    <el-col :span="24" class="warp-breadcrum border-default breadcrum_top">
      <el-table stripe border :data="tableData" v-loading="listLoading" style="width: 100%">
        <el-table-column prop="name" label="促销名称" sortable></el-table-column>
        <el-table-column prop="typeName" label="促销类别" sortable></el-table-column>
...
//        })
//        if (bool == true) {
          this.$router.push({path: 'list', query: {couponId: index.id}});
//        } else {
//          this.$message({
//            message: '亲，您暂无此权限哦！',
//            type: 'warning'
