    ...
    <el-row class="breadcrumb-border">
      <el-col>
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: '/scrap/list' }">报损列表</el-breadcrumb-item>
          <el-breadcrumb-item>报损明细</el-breadcrumb-item>
        </el-breadcrumb>
      </el-col>
    </el-row>
    <el-row class="data-table" :gutter="2">
      <el-col :span="7">报损单号：{{this.$route.params.no}}</el-col>
      <el-col :span="4">报损人：{{this.$route.params.user}}</el-col>
      <el-col :span="3">报损数量：{{this.$route.params.quantity}}</el-col>
      <el-col :span="2" class="tool-bar f-fr">
        <el-tooltip class="item" effect="light" content="返回报损管理列表" placement="left" >
    ...
    <el-row :gutter="2">
      <el-col :span="24"  v-loading="loading">
        <el-table stripe border :data="list" border show-summary :summary-method="detailSummary">
          ...
          <el-table-column  prop="quantity" sortable  label="报损数量" width="120" align="center">
            <template scope="scope">
              <span class="inventory_color">{{scope.row.quantity}}</span>
            </template>
          </el-table-column>
          <el-table-column  prop="reason" label="报损原因" align="center" ></el-table-column>
        </el-table>
      </el-col>
    </el-row>
  </div>
