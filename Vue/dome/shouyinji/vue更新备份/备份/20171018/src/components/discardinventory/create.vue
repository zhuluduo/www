  ...
  <div>
    <el-row class="breadcrumb-border">
      <el-col>
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: '/discardinventory/list' }">出库单</el-breadcrumb-item>
    ...
    <el-row :gutter="2">
      ...
      <el-col :span="4" class="tool-bar f-fr">
        ...
        <el-button type="primary" @click="save(list)" size="small">提交出库</el-button>
      </el-col>
    </el-row>
    <el-row>
      <el-col>
        <el-table :data="list" v-loading="loading">
          ...
          <el-table-column prop="quantity" label="出库原因" width="300">
            <template scope="scope">
