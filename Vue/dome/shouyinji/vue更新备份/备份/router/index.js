...
// import ReportedList from '@/components/discardinventory/list' // 报损单
// import Create from '@/components/discardinventory/create' // 新增报损
// import Detail from '@/components/discardinventory/detail' // 报损单详情
import InventoryWarning from '@/components/inventory/warning' // 库存预警

/*报损管理*/
import ScrapList from '@/components/scrap/list' // 报损单列表
import ScrapCreate from '@/components/scrap/create' // 新增报损
import ScrapDetail from '@/components/scrap/detail' // 报损单详情
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {path: '/scrap/list', component: ScrapList, name: '报损管理', menuShow: true},
        {path: '/scrap/create', component: ScrapCreate, name: '新增报损', menuShow: false},
        {path: '/scrap/detail/:id/:no/:user/:quantity', component: ScrapDetail, name: '报损单详情', menuShow: false},
      ]
    },
    {
      path: '/',
