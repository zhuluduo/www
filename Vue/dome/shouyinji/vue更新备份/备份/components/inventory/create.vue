  ...
  <div>
    ...
    <el-dialog title="提示" :visible.sync="showDialog" size="tiny">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="showDialog = false" icon="close" size="small">取 消</el-button>
        <el-button type="primary" @click="$router.push('list')" icon="check" size="small">确 定</el-button>
      </span>
    </el-dialog>
      ...
      validate(rows) {
        try{
          rows.forEach((e)=>{
            ...
            if(e.products[0].purchasePrice==null||e.products[0].purchasePrice=='') {
...
//        }
      ...
      dialogConfirm(){
        ...
        this.list = this.selectedProducts
        let idValueMap=[];
...
<style>
  ...
  @media (max-width:1366px) {  .selectedProducts_tag .el-table tr span{width: 82px;}}
