    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-row>
        <el-col :span="12" >
          ...
          <el-form-item label="二级分类:" prop="selectedDepart">
        ...
        <el-col :span="12">
          ...
          <el-form-item label="采购价格:" prop="purchasePrice">
            <el-input v-model="ruleForm['products'][0]['purchasePrice']" id="inputNumber" onblur="checkNumber" @input="onpurchasePrice(ruleForm)" size="small" class="jfun-form-input"/>
          </el-form-item>
          ...
          <el-form-item label="库存数量:" prop="inventory">
            <el-input v-model="ruleForm['products'][0]['inventory']" @input="oninventory(ruleForm)" size="small" class="jfun-form-input"/>
          </el-form-item>
          <el-form-item label="安全天数:" prop="safetyInventoryDays">
            <el-input v-model="ruleForm['products'][0]['safetyInventoryDays']" @input="onsafetyInventoryDays(ruleForm)" size="small" class="jfun-form-input"/>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                  if (valid) {
                    ...
                    let pu = this.ruleForm['products'][0]['purchasePrice'];
                    let se = this.ruleForm['products'][0]['sellingPrice'];
                    let inv = this.ruleForm['products'][0]['inventory'];
                    let sa = this.ruleForm['products'][0]['safetyInventoryDays'];
                    if (this.$data.selectedDepart == '') {
                      this.$message.error('请选择二级分类');
                      return false;
                    } else if (pu == '' | se == '' | inv == '' | sa == '') {
                      this.$message.error('上架信息不能为空');
                      return false;
                    }
