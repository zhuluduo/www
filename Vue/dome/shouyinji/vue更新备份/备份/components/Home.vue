  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      <div class="topbar-logo topbar-btn">
        <a href="/"><img src="../assets/logo.png" style="padding-top: 15px;padding-bottom: 6px;"/></a>
      </div>
    ...
    <el-col :span="24" class="main">
      ...
      <aside :class="collapsed?'menu-collapsed':'menu-expanded'">
        ...
        <div class="menu-toggle" @click.prevent="collapse">
          <i class="iconfont icon-menu" v-show="!collapsed"></i>
          <i class="iconfont icon-menu" v-show="collapsed"></i>
        </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /*注销*/
      logout(){
        this.$axios.get(bus.host+'/pos/logout?_='+new Date().getTime()).then(res=>{
