        ...
        <el-col  :sm="24" :md="24" :lg="24">
          <el-dialog title="商品添加" :visible.sync="dialogFormVisible" ref='dialog' @close="show()" >
            ...
            <div slot="footer" class="dialog-footer">
              ...
              <el-button type="primary" @click="update" class="fr mg_r"  :class="this.Giveaway2==false?'checked_len_true':'checked_len_false'">确 定1</el-button>
              <el-button type="primary" @click="upGiveaway" class="fr mg_r"  :class="this.Giveaway1==false?'checked_len_true':'checked_len_false'">确 定2</el-button>
            </div>
          </el-dialog>
        </el-col>
      </el-form>
