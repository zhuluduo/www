...
/*外卖管理*/
import TakeawayList from '@/components/takeaway/list' //待处理外卖订单
...
import StockTakingCreate from '@/components/inventory/stocktaking/create' // 盘点创建
import StockTakingDetail from '@/components/inventory/stocktaking/detail' // 盘点明细
import InventoryWarning from '@/components/inventory/warning/list' // 库存预警
import InventoryWarningDetail from '@/components/inventory/warning/detaillist' // 库存预警
import InventoryWarningUnmatchList from '@/components/inventory/warning/unmatchList' // 库存预警
...
//import Swagger from '@/components/system/swagger' // swagger
import SystemStoresetting from '@/components/system/storesetting' //商铺设置
import SystemTakeoutSetting from '@/components/system/takeoutsetting' //外卖平台设置
import SystemTakeaway from '@/components/system/takeaway' //外卖平台设置

/*统计分析*/
import StatisticsProduct from '@/components/statistics/product' // 商品分析
import StatisticsShift from '@/components/statistics/shift/list' // 商品分析
import StatisticsABCProduct from '@/components/statistics/abc' // 商品分析
...
import TakeoutOrderList from '@/components/sale/takeout/list' // 外卖订单列表
...
// mode: 'history',
  routes: [
    ...
    },
    {
      ...
      children:[
        {path:'/list',component:TakeawayList,name:'待处理买卖订ss单',menuShow:true},
      ]
    },
    {
      path: '/',
    ...
    },
    {
      ...
      children: [
        ...
        {path: '/inventory/warning/list', component: InventoryWarning, name: '库存预警', menuShow: true},
        {path: '/inventory/warning/detaillist', component: InventoryWarningDetail, name: '预警订单', menuShow: false},
        {path: '/inventory/warning/unmatchList', component: InventoryWarningUnmatchList, name: '外部采购', menuShow: false},
        ...
        {path: '/inventory/stocktaking/create', component: StockTakingCreate, name: '编辑盘点', menuShow: false},
        {path: '/inventory/stocktaking/detail', component: StockTakingDetail, name: '盘点明细', menuShow: false},
        ...
        {path: '/scrap/detail/:id/:no/:user/:quantity/:type', component: ScrapDetail, name: '出库单详情', menuShow: false},
      ]
    },
    {
      path: '/',
      ...
      children: [
        ...
        {path: '/sale/takeout/list', component: TakeoutOrderList, name: '外卖订单', menuShow: true},
    ...
    },
    {
      ...
      children: [
        ...
        {path: '/statistic/abc', component: StatisticsABCProduct, name: 'ABC类品', menuShow: true},
        {path: '/statistic/shift/list', component: StatisticsShift, name: '交班记录', menuShow: true}
      ]
    },
    {
      path: '/',
      ...
      children: [
        ...
        {path: '/system/storesetting', component: SystemStoresetting, name: '店铺设置', menuShow: true},
        {path: '/system/takeoutsetting', component: SystemTakeoutSetting, name: '外卖设置', menuShow: true},
        //{path: '/system/swagger', component: Swagger, name: '开放接口', menuShow: true},
      ]
    },
    {
      path: '/',
