...
<script>
      ...
      export default {
        ...
        methods: {
          ...
          save() {
            this.loading=true;
            let store={id:this.store.id,adv1:this.adv1.adv1,adv2:this.adv2.adv2,adv3:this.adv3.adv3};
            let url = bus.host + '/pos/api/store/update/advertisement';
            this.$http.put(url, store).then((response) => {
          ...
          getStore(){
            ...
            this.$http.get(url).then((response) => {
              let store = response.data.msg;
              this.adv1.adv1=store.adv1;
              this.adv2.adv2=store.adv2;
              this.adv3.adv3=store.adv3;
              this.adv1.showUrl=store.adv1==undefined?'':bus.imgHost+store.adv1;
              this.adv2.showUrl=store.adv2==undefined?'':bus.imgHost+store.adv2;
              this.adv3.showUrl=store.adv3==undefined?'':bus.imgHost+store.adv3;
              this.store=store;
