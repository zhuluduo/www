<template>
    <div style="display: inline-block">
      ...
      <el-dialog title="商品添加" :visible.sync="dialogFormVisible" ref='dialog' @close="show()"  class="widthList">
        ...
        <el-col :span="19">
          <el-row :gutter="2">
            <el-col :span="8">
              <el-col :sm="7" :md="7" :lg="8">
                <el-checkbox  v-model="checkAll" @change="handleCheckAllChange">全选</el-checkbox>
              </el-col>
              <el-col :sm="17" :md="17" :lg="16">
        ...
        methods: {
          ...
          handleCheckAllChange(event){
            if(event.target.checked===true){
              let pg = "?page=" +'0' + "&size=" +  this.total;
              this.$http.post(this.url + pg,this.listQuery, {}).then((response) => {
                this.product_list = response.data.msg.content;
                this.tableData_Load = this.product_list;
                if(event.target.checked===true){
                  this.tableData_Load.forEach(e=>{
