    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-row>
        ...
        <el-col :span="12">
          ...
          <!--<el-form-item label="店铺上架">-->
            <!--<el-checkbox-group v-model="ruleForm.shopShelves">-->
              <!--<el-checkbox label="1" >实体店上架</el-checkbox>-->
              <!--<el-checkbox label="2" >网店上架</el-checkbox>-->
            <!--</el-checkbox-group>-->
          <!--</el-form-item>-->
        </el-col>
      </el-row>
      <el-row>
        <el-col align="center" class="buttonTop">
...
//          },
          ...
          validate(rows) {
            try{
                ...
                if(rows['products'][0]['inventory']==null||rows['products'][0]['inventory']=='') {
