<template>
  <el-row v-loading="loading" :element-loading-text="loadingText">
    ...
    <el-col :span="24">
      <div class="login-box web-login-box">
        ...
        <div  v-if="appLink!=''" class="web-jfun-download"><a v-bind:href="appLink"><i class="iconfont icon-jfun-download"/>下载收银APP</a></div>
      </div>
    </el-col>
    <el-col :span="24" class="footer">
      <div v-if="appLink!=''" class="jfun-download" style="margin-bottom: 20px"><a v-bind:href="appLink"><i class="iconfont icon-jfun-download"/>下载收银APP</a></div>
...
<script>
    ...
    export default {
        ...
        mounted() {
          ...
          let u=this.getQueryString('_u');
          let p=this.getQueryString('_p');
          if(u&&p){
            this.user={username:u,password:p};
            this.login();
          }
        }
    }
...
<style lang="scss" scoped>
  .web-jfun-download{display: none;}
  .login-box{
    position: relative;
    width:791px;
    height: 441px;
  ...
  @media only screen and (max-width: 750px){
    .jfun-download{display: none;}
    .web-jfun-download{display: block;}
    .web-login-box{
      width:350px;
      height: 410px;
      background: url('../assets/images/web-logins.png') no-repeat center;
      background-size: 100%;
