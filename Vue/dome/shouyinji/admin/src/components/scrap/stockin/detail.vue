    ...
    <el-row class="breadcrumb-border">
      <el-col>
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: '/scrap/stockin/list' }">商品入库</el-breadcrumb-item>
    ...
    <el-row class="data-table" :gutter="2" style="font-size: 15px;">
      ...
      <el-col :span="3" class="tool-bar f-fr">
        <el-tooltip class="item" effect="light" content="返回商品入库列表" placement="left" >
          <el-button :plain="true" type="warning" @click="$router.push('/scrap/stockin/list')" size="small" icon="arrow-left">返回列表</el-button>
        </el-tooltip>
  ...
  export default{
    ...
    methods: {
      loadDetail(){
        ...
        let url = bus.host+'/admin/api/inventory/stockin/detail/'+id
        this.loading=true;
