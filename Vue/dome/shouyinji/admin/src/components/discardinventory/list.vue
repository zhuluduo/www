    ...
    <el-row :gutter="2">
      <el-col :span="24"  v-loading="loading">
        <el-table :data="list" show-summary :summary-method="listSummary" >
          <el-table-column  prop="no" label="出库单号"></el-table-column>
          <el-table-column  prop="updateTime" label="出库时间" ></el-table-column>
          ...
          <el-table-column label="操作" width="180" align="center">
            <template scope="scope">
              ...
              <el-button :plain="true" type="danger" @click="listrmove(scope.row,scope.$index)" size="small">导出</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
  ...
  export default {
    ...
    methods: {
      ...
      listTable(){
        ...
        let url=bus.host+'/admin/api/inventory/scrap/list'+pg;
        this.loading = true;
      ...
      listrmove(row,index){
        let id=row.id;
        let url=bus.host+'/admin/api/inventory/scrap/del?id=';
