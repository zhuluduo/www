    ...
    <el-row class="breadcrumb-border">
      <el-col>
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: 'list' }">盘点记录</el-breadcrumb-item>
...
<script>
  ...
  export default {
    data() {
      return {
        url: bus.host + '/admin/api/check/detailslist',
        list: [],
        listSort: {},
        listQuery: {
          pageSize: 15,
    ...
    methods: {
      ...
      /*分类*/
      Primaryone() {
        let url = bus.host + '/admin/api/category/list/0'
      ...
      submitForm() {
        ...
        let url = bus.host + '/admin/api/check/updatedetail'
      ...
      /*结束盘点*/
      check_submit(){
        let url = bus.host + '/admin/api/check/sava'
